...
- [Project Overview](#project-overview)
  - [Download Trained Parameters](#download-trained-parameters)
...
The final trained transformation-aware checkpoint is hosted externally because of its file size:

**[Download `transformation_aware_best.pt` from Google Drive](https://drive.google.com/file/d/1B0vFDue3KUo1_rUf2dCt-PXgaQFR5xjw/view?usp=sharing)**

After downloading, place the file in the repository's `checkpoints` directory. Create the directory if it does not already exist, and ensure the filename and resulting path are exactly:

```text
checkpoints/transformation_aware_best.pt
```

This is the default checkpoint path used by the inference and transformation-aware evaluation commands.
